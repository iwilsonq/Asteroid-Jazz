...
#ifndef __Asteroid_Jazz__Entity__
#define __Asteroid_Jazz__Entity__
...
public:
    ...
    virtual ~Entity();  // Virtual because entity is polymorphic
...
#endif /* defined(__Asteroid_Jazz__Entity__) */
